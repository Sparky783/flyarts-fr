    ...
    <div className="row">
      <section className="col-sm-12">
        <div className="jumbotron">
          <h1 className="display-4">FlyArts</h1>
          <p className="lead">Mon petit site perso pour y mettre mes projets, mes passions et un peu de moi en ligne.</p>
        </div>
      </section>

      <section id="portrait" className="col-sm-12 flyarts-section">
        <div className="row">
          <div className="col-md-4">
            <img className="rounded float-left img-thumbnail" src="./src/assets/img/portrait.jpg" alt="..." />
          </div>
          ...
          <div className="col-md-8">
            ...
            <p className="text-right">
              <NavLink className="btn btn-danger btn-lg" to="/cv">Accéder à mon CV</NavLink>
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="col-md-12 shadow">
        <div className="row">
          <section className="col-md-6 flyarts-section">
